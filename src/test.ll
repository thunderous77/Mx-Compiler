...
@asciiTable = global i8* zeroinitializer, align 8
@MAXCHUNK = global i32 zeroinitializer, align 4
@MAXLENGTH = global i32 zeroinitializer, align 4
@chunks = global i32** zeroinitializer, align 8
@inputBuffer = global i32* zeroinitializer, align 8
@outputBuffer = global i32* zeroinitializer, align 8
...
@.strconst.1 = private unnamed_addr constant [1 x i8] c"\00", align 1
